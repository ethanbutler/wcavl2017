...
class Hooky {
  function __construct(){
    ...
    //the following line is modified from original so that function will be called on theme activation
    add_action('after_setup_theme',    array($this, 'hooky_db'));
  ...
  function hooky_admin_scripts($hook){
    ...
    // the following line is modified from original so that path will work
    wp_enqueue_script('hooky/js', get_stylesheet_directory_uri() . '/lib/hooky/assets/dist/hooky.min.js', [], null, true);
